...
namespace DrawSubRegionPolyomino
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Paint(object sender, PaintEventArgs e)
        {
            ...
            foreach (Control item in panel1.Controls)
            {
                ...
                if (item is TextBox&&item.Text!="")
                {
                    ...
                    pts.Add(new Point(textnum%10,textnum/10));
                    groups.Add(item.Text);
                }
            }

            DrawPoly(new Pen(Color.Black, penWidth), gp, gridsize, 
                pts.ToArray(),groups.ToArray(), roundratio);
            gp.Dispose();
        }
        ...
        private void DrawPoly(Pen pen, Graphics gp,double gridsize,Point[] pts,string[] group,double roundRatio)
        {
